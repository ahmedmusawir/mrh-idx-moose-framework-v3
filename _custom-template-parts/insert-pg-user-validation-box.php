<!-- LIST INSERT PAGE USER VALDATION BOX  -->
<section id="list-insert-user-validation-box" class="card p-5 animate__animated animate__zoomIn d-none">
  ...
  <ul class="list-group">
    ...
    <li class="list-group-item">Name: <span class="pl-3 font-weight-bold" id="list-user-validation-name"></span></li>
    <li class="list-group-item">Phone: <span class="pl-3 font-weight-bold" id="list-user-validation-phone"></span></li>
    <li class="list-group-item">Website: <span class="pl-3 font-weight-bold" id="list-user-validation-website"></span>
    </li>
    <li class="list-group-item">City: <span class="pl-3 font-weight-bold" id="list-user-validation-city"></span></li>
    <li class="list-group-item">State: <span class="pl-3 font-weight-bold" id="list-user-validation-state"></span></li>
    <!-- SOCIAL MEDIA LINKS -->
    <li class="list-group-item">Facebook: <span class="pl-3 font-weight-bold" id="list-user-validation-facebook"></span>
    </li>
    <li class="list-group-item">Yelp: <span class="pl-3 font-weight-bold" id="list-user-validation-yelp"></span></li>
    <li class="list-group-item">Instagram: <span class="pl-3 font-weight-bold"
        id="list-user-validation-instagram"></span></li>
    <li class="list-group-item">Linkedin: <span class="pl-3 font-weight-bold" id="list-user-validation-linkedin"></span>
    </li>
    <li class="list-group-item">Google Plus: <span class="pl-3 font-weight-bold"
        id="list-user-validation-google-plus"></span></li>
    <li class="list-group-item">Twitter: <span class="pl-3 font-weight-bold" id="list-user-validation-twitter"></span>
    </li>
  </ul>
